...
@property (nonatomic, unsafe_unretained) BOOL topViewIsMoved;
...
/** Specifies if overpanning is allowed
 
 By default this is off, such that you can drag the sidebars as far as you want.
 */
@property (nonatomic, unsafe_unretained) BOOL disableOverPanning;
...
/** Slides the top view in the direction of the specified side.
 ...
 @param side The side for the top view to slide towards.
 @param duration The duration for moving the topView to the side.
