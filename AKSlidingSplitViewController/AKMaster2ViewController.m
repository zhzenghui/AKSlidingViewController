...
@interface AKMaster2ViewController () {
    NSMutableArray *_objects;
}
@end

@implementation AKMaster2ViewController

- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil];
    if (self) {
        self.title = NSLocalizedString(@"Master2", @"Master2");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
	    if (!self.detailViewController) {
	        self.detailViewController = [[[AKDetail2ViewController alloc] initWithNibName:@"AKDetailViewController_iPhone" bundle:nil] autorelease];
	    }
